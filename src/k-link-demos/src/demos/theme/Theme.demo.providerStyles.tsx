...
import { MantineProvider, Button, Badge, Group, ButtonStylesParams, rem } from '@k-link/core';

const code = `
import { MantineProvider, Group, Button, Badge, ButtonStylesParams } from '@k-link/core';
