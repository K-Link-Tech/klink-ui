...
import { Dropzone, IMAGE_MIME_TYPE } from '@k-link/dropzone';
import { MantineDemo } from '@k-link/ds';
import { DropzoneDemoChildren } from './_base';

const code = `
import { useState } from 'react';
import { Group, Text, useMantineTheme, Button } from '@k-link/core';
import { IconUpload, IconPhoto, IconX } from '@tabler/icons-react';
import { Dropzone, DropzoneProps, IMAGE_MIME_TYPE } from '@k-link/dropzone';
