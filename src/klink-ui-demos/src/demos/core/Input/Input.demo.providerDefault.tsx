...
import { TextInput, MultiSelect, NumberInput, MantineProvider, Box } from '@klink-ui/core';

const code = `
import { TextInput, MultiSelect, NumberInput, MantineProvider } from '@klink-ui/core';
