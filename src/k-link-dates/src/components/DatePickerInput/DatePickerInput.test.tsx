...
describe('@k-link/dates/DatePickerInput', () => {
  itSupportsSystemProps({
    component: DatePickerInput,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'DatePickerInput',
    othersSelector: '.k-link-DatePickerInput-input',
    displayName: '@k-link/dates/DatePickerInput',
  });

  itSupportsFocusEvents(DatePickerInput, defaultProps, '.k-link-DatePickerInput-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-DatePickerInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'k-link-DatePickerInput-input'
    );

    expect(container.querySelector('table button')).toHaveClass('k-link-DatePickerInput-day');
  });
