...
describe('@k-link/dates/DateInput', () => {
  ...
  itSupportsSystemProps({
    ...
    displayName: '@k-link/dates/DateInput',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-DateInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass('k-link-DateInput-input');

    expect(container.querySelector('table button')).toHaveClass('k-link-DateInput-day');
  });
