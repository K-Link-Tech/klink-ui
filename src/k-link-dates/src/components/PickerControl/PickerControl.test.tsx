...
describe('@k-link/dates/PickerControl', () => {
  itSupportsSystemProps({
    component: PickerControl,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'PickerControl',
    displayName: '@k-link/dates/PickerControl',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('k-link-PickerControl-pickerControl');
  });

  it('supports custom __staticSelector', () => {
    render(<PickerControl {...defaultProps} __staticSelector="Calendar" />);
    expect(screen.getByRole('button')).toHaveClass('k-link-Calendar-pickerControl');
  });
