...
describe('@k-link/dates/YearPickerInput', () => {
  itSupportsSystemProps({
    component: YearPickerInput,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'YearPickerInput',
    othersSelector: '.k-link-YearPickerInput-input',
    displayName: '@k-link/dates/YearPickerInput',
  });

  itSupportsFocusEvents(YearPickerInput, defaultProps, '.k-link-YearPickerInput-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-YearPickerInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'k-link-YearPickerInput-input'
    );

    expect(container.querySelector('table button')).toHaveClass(
      'k-link-YearPickerInput-pickerControl'
    );
  });
