...
describe('@k-link/dates/MonthPickerInput', () => {
  itSupportsSystemProps({
    component: MonthPickerInput,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'MonthPickerInput',
    othersSelector: '.k-link-MonthPickerInput-input',
    displayName: '@k-link/dates/MonthPickerInput',
  });

  itSupportsFocusEvents(MonthPickerInput, defaultProps, '.k-link-MonthPickerInput-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-MonthPickerInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'k-link-MonthPickerInput-input'
    );

    expect(container.querySelector('table button')).toHaveClass(
      'k-link-MonthPickerInput-pickerControl'
    );
  });
