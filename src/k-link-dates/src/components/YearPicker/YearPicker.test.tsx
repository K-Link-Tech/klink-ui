...
describe('@k-link/dates/YearPicker', () => {
  itSupportsSystemProps({
    component: YearPicker,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'YearPicker',
    displayName: '@k-link/dates/YearPicker',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-YearPicker-calendar');
  });
