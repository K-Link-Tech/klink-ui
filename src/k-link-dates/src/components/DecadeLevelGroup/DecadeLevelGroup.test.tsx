...
describe('@k-link/dates/DecadeLevelGroup', () => {
  itSupportsSystemProps({
    component: DecadeLevelGroup,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'DecadeLevelGroup',
    displayName: '@k-link/dates/DecadeLevelGroup',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-DecadeLevelGroup-decadeLevelGroup');
    expect(container.querySelector('table button')).toHaveClass(
      'k-link-DecadeLevelGroup-pickerControl'
    );
  });
  ...
  it('supports custom __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-Calendar-decadeLevelGroup');
    expect(container.querySelector('table button')).toHaveClass('k-link-Calendar-pickerControl');
  });
