...
import { DefaultProps, Box, Selectors, useComponentDefaultProps, MantineSize } from '@k-link/core';
      ...
      return (
        ...
        >
          <PickerControl
            ...
            data-k-link-stop-propagation={__stopPropagation || undefined}
...
MonthsList.displayName = '@k-link/dates/MonthsList';
