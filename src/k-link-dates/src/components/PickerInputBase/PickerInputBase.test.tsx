...
describe('@k-link/dates/PickerInputBase', () => {
  ...
  it('supports __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-TestStaticSelector-root');
    expect(screen.getByText('test-value')).toHaveClass('k-link-TestStaticSelector-input');
  });
  ...
  it('changes between Popover and Modal based on dropdownType prop', () => {
    ...
    expect(container.querySelector('.k-link-Popover-dropdown')).toBeInTheDocument();
    expect(container.querySelector('.k-link-Modal-content')).not.toBeInTheDocument();
    expect(screen.getByText('test-children')).toBeInTheDocument();

    rerender(<PickerInputBase {...defaultProps} dropdownOpened dropdownType="modal" />);
    expect(container.querySelector('.k-link-Popover-dropdown')).not.toBeInTheDocument();
    expect(container.querySelector('.k-link-Modal-content')).toBeInTheDocument();
    expect(screen.getByText('test-children')).toBeInTheDocument();
  });
