...
describe('@k-link/dates/DateTimePicker', () => {
  itSupportsSystemProps({
    component: DateTimePicker,
    props: defaultProps,
    providerName: 'DateTimePicker',
    othersSelector: '.k-link-DateTimePicker-input',
    displayName: '@k-link/dates/DateTimePicker',
  });

  itSupportsFocusEvents(DateTimePicker, defaultProps, '.k-link-DateTimePicker-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-DateTimePicker-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'k-link-DateTimePicker-input'
    );

    expect(container.querySelector('table button')).toHaveClass('k-link-DateTimePicker-day');
  });
