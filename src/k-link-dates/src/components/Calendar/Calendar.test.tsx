...
describe('@k-link/dates/Calendar', () => {
  itSupportsSystemProps({
    component: Calendar,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'Calendar',
    displayName: '@k-link/dates/Calendar',
  });
  ...
  itHandlesControlsKeyboardEvents(Calendar, 'year', '.k-link-MonthsList-monthsList', {
    ...defaultProps,
    level: 'year',
  });
  itHandlesControlsKeyboardEvents(Calendar, 'decade', '.k-link-YearsList-yearsList', {
    ...defaultProps,
    level: 'decade',
  });
