...
describe('@k-link/dates/MonthLevelGroup', () => {
  itSupportsSystemProps({
    component: MonthLevelGroup,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'MonthLevelGroup',
    displayName: '@k-link/dates/MonthLevelGroup',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-MonthLevelGroup-monthLevelGroup');
    expect(container.querySelector('table button')).toHaveClass('k-link-MonthLevelGroup-day');
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<MonthLevelGroup {...defaultProps} __staticSelector="Calendar" />);
    expect(container.firstChild).toHaveClass('k-link-Calendar-monthLevelGroup');
    expect(container.querySelector('table button')).toHaveClass('k-link-Calendar-day');
  });
