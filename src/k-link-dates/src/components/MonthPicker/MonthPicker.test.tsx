...
describe('@k-link/dates/MonthPicker', () => {
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('k-link-MonthPicker-calendar');
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<MonthPicker {...defaultProps} __staticSelector="Calendar" />);
    expect(container.firstChild).toHaveClass('k-link-Calendar-calendar');
  });
});
