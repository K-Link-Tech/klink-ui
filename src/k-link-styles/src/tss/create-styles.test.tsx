...
describe('@k-link/styles/create-styles', () => {
  ...
  it('generates name based on name param', () => {
    ...
    expect(screen.getByText('test-element')).toHaveClass('k-link-NamedComponent-testObject');
  });
  ...
  it('adds correct static selectors for multiple names', () => {
    ...
    expect(screen.getByText('test-element')).toHaveClass('k-link-NamedComponent-testObject');
    expect(screen.getByText('test-element')).toHaveClass('k-link-TestName-testObject');
  });
