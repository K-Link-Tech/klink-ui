...
import { useMergedRef, assignRef, useOs, clamp } from '@klink-ui/hooks';
import { DefaultProps, Selectors, useComponentDefaultProps, rem, getSize } from '@klink-ui/styles';
...
NumberInput.displayName = '@klink-ui/core/NumberInput';
