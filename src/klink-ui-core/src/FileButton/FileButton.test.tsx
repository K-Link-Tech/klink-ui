...
import { checkAccessibility, itSupportsRef } from '@klink-ui/tests';
...
describe('@klink-ui/core/FileButton', () => {
  ...
  it('has correct displayName', () => {
    expect(FileButton.displayName).toEqual('@klink-ui/core/FileButton');
  });
});
