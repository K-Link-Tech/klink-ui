...
import { DefaultProps, Selectors, useComponentDefaultProps, rem } from '@klink-ui/styles';
import { useElementSize } from '@klink-ui/hooks';
...
Spoiler.displayName = '@klink-ui/core/Spoiler';
