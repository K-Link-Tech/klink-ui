...
import { getSafeId } from '@klink-ui/utils';
import { useUncontrolled, useId } from '@klink-ui/hooks';
import { ClassNames, MantineColor, MantineNumberSize, Styles } from '@klink-ui/styles';
...
TabsProvider.displayName = '@klink-ui/core/TabsProvider';
