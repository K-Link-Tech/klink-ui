...
import { ForwardRefWithStaticComponents, packSx } from '@klink-ui/utils';
import { Box } from '../Box';
...
ScrollAreaAutosize.displayName = '@klink-ui/core/ScrollAreaAutosize';
_ScrollArea.displayName = '@klink-ui/core/ScrollArea';
