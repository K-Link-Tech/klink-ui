...
import { useId, useUncontrolled } from '@klink-ui/hooks';
import { Selectors, DefaultProps, useComponentDefaultProps, rem, getSize } from '@klink-ui/styles';
...
PasswordInput.displayName = '@klink-ui/core/PasswordInput';
