...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.klink-ui-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.klink-ui-InputWrapper-error'),
  getRequired: (container: HTMLElement) =>
    container.querySelector('.klink-ui-InputWrapper-required'),
  getDescription: (container: HTMLElement) =>
    container.querySelector('.klink-ui-InputWrapper-description'),
};

describe('@klink-ui/core/InputWrapper', () => {
  itRendersChildren(InputWrapper, defaultProps);
  itSupportsSystemProps({
    component: InputWrapper,
    props: defaultProps,
    displayName: '@klink-ui/core/InputWrapper',
