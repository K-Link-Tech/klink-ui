...
import { itRendersChildren, checkAccessibility } from '@klink-ui/tests';
...
describe('@klink-ui/core/HoverCard', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCard.displayName).toEqual('@klink-ui/core/HoverCard');
  });
});
