...
import { itThrowsContextError, patchConsoleError, createContextContainer } from '@klink-ui/tests';
...
describe('@klink-ui/core/HoverCardTarget', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCardTarget.displayName).toEqual('@klink-ui/core/HoverCardTarget');
  });
});
