...
import { itRendersChildren, itSupportsRef, itSupportsSystemProps } from '@klink-ui/tests';
...
describe('@klink-ui/core/Dialog', () => {
  ...
  it('has correct displayName', () => {
    expect(Dialog.displayName).toStrictEqual('@klink-ui/core/Dialog');
  });
});
