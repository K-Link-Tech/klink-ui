...
import { DefaultProps, Selectors, useComponentDefaultProps } from '@klink-ui/styles';
import { createScopedKeydownHandler } from '@klink-ui/utils';
...
AccordionControl.displayName = '@klink-ui/core/AccordionControl';
