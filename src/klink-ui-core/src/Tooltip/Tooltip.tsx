...
import { isElement, ForwardRefWithStaticComponents } from '@klink-ui/utils';
import { useMergedRef } from '@klink-ui/hooks';
import { getDefaultZIndex, useComponentDefaultProps } from '@klink-ui/styles';
...
_Tooltip.displayName = '@klink-ui/core/Tooltip';
