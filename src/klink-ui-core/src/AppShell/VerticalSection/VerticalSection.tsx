...
import { DefaultProps, getDefaultZIndex, Global, rem, em } from '@klink-ui/styles';
import { Box } from '../../Box';
      ...
      typeof height === 'object' && height !== null
        ? getSortedBreakpoints(height, theme).reduce((acc, [breakpoint, breakpointSize]) => {
            acc[`@media (min-width: ${em(breakpoint)})`] = {
              [`--klink-ui-${section}-height`]: rem(breakpointSize),
            };
...
VerticalSection.displayName = '@klink-ui/core/VerticalSection';
