...
import { DefaultProps, MantineNumberSize, useComponentDefaultProps } from '@klink-ui/styles';
import { useUncontrolled } from '@klink-ui/hooks';
...
TransferList.displayName = '@klink-ui/core/TransferList';
