...
describe('@k-link/core/Menu', () => {
  ...
  it('correctly handles withArrow={true}', () => {
    ...
    expect(document.querySelectorAll('.k-link-Menu-arrow')).toHaveLength(1);
  });

  it('correctly handles withArrow={false}', () => {
    render(<TestContainer defaultOpened withArrow={false} />);
    expect(document.querySelectorAll('.k-link-Menu-arrow')).toHaveLength(0);
  });
  ...
  it('has correct displayName', () => {
    expect(Menu.displayName).toEqual('@k-link/core/Menu');
  });
});
