...
import { itRendersChildren, itSupportsRef, itSupportsSystemProps } from '@k-link/tests';
...
describe('@k-link/core/Dialog', () => {
  ...
  it('has correct displayName', () => {
    expect(Dialog.displayName).toStrictEqual('@k-link/core/Dialog');
  });
});
