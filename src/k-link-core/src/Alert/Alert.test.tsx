...
describe('@k-link/core/Alert', () => {
  ...
  it('renders close button based on withCloseButton prop', () => {
    ...
    expect(withCloseButton.querySelector('.k-link-Alert-closeButton')).toBeInTheDocument();
    expect(withoutCloseButton.querySelectorAll('.k-link-Alert-closeButton')).toHaveLength(0);
  });
  ...
  it('does not render title if title prop was not passed', () => {
    ...
    expect(container.querySelectorAll('.k-link-Alert-title')).toHaveLength(0);
  });
