...
import { DefaultProps, Selectors, useMantineTheme, useComponentDefaultProps } from '@k-link/styles';
import { ForwardRefWithStaticComponents, packSx } from '@k-link/utils';
import { Box } from '../Box';
...
ScrollAreaAutosize.displayName = '@k-link/core/ScrollAreaAutosize';
_ScrollArea.displayName = '@k-link/core/ScrollArea';
