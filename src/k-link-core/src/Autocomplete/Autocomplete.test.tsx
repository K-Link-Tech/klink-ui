...
const queries = {
  getDropdown: (container: HTMLElement) => container.querySelector('.k-link-Autocomplete-dropdown'),
  getItems: (container: HTMLElement) => container.querySelectorAll('.k-link-Autocomplete-item'),
};

describe('@k-link/core/Autocomplete', () => {
  ...
  itSupportsFocusEvents(Autocomplete, defaultProps, '.k-link-Autocomplete-input');
  itSupportsSystemProps({
    component: Autocomplete,
    props: defaultProps,
    displayName: '@k-link/core/Autocomplete',
    refType: HTMLInputElement,
    othersSelector: '.k-link-Autocomplete-input',
