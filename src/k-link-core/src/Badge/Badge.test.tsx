...
describe('@k-link/core/Badge', () => {
  ...
  it('renders given left and right section', () => {
    ...
    expect(container.querySelector('.k-link-Badge-rightSection').textContent).toBe('test-right');
    expect(container.querySelector('.k-link-Badge-leftSection').textContent).toBe('test-left');
  });
});
