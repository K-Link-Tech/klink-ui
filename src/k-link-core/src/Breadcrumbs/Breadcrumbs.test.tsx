...
describe('@k-link/core/Breadcrumbs', () => {
  ...
  it('renders correct amount of children and separators', () => {
    ...
    expect(container.querySelectorAll('.k-link-Breadcrumbs-breadcrumb')).toHaveLength(3);
    expect(container.querySelectorAll('.k-link-Breadcrumbs-separator')).toHaveLength(2);
  });
