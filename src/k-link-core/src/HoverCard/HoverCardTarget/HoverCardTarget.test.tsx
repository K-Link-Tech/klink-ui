...
import { itThrowsContextError, patchConsoleError, createContextContainer } from '@k-link/tests';
...
describe('@k-link/core/HoverCardTarget', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCardTarget.displayName).toEqual('@k-link/core/HoverCardTarget');
  });
});
