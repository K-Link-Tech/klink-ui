...
describe('@k-link/core/PinInput', () => {
  ...
  it('renders correct amount of inputs based on length prop', () => {
    ...
    expect(container.querySelectorAll('.k-link-PinInput-input')).toHaveLength(5);
  });
  ...
  it('onComplete is called on last input', () => {
    ...
    expect(container.querySelectorAll('.k-link-PinInput-input')).toHaveLength(4);

    container.querySelectorAll('.k-link-PinInput-input').forEach((element) => {
