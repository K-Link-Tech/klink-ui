...
describe('@k-link/core/Select/SelectItems', () => {
  it('renders nothing found message if data array is empty', () => {
    ...
    expect(withData.querySelectorAll('.k-link-Select-nothingFound')).toHaveLength(0);
    expect(withoutData.querySelector('.k-link-Select-nothingFound').textContent).toBe(
      'test-nothing'
    );
  });
  ...
  it('has correct displayName', () => {
    expect(SelectItems.displayName).toStrictEqual('@k-link/core/SelectItems');
  });
});
