...
import { isElement, ForwardRefWithStaticComponents } from '@k-link/utils';
import { useMergedRef } from '@k-link/hooks';
import { getDefaultZIndex, useComponentDefaultProps } from '@k-link/styles';
...
_Tooltip.displayName = '@k-link/core/Tooltip';
