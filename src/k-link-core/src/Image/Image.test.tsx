...
describe('@k-link/core/Image', () => {
  ...
  it('renders placeholder based on withPlaceholder prop', () => {
    ...
    expect(withPlaceholder.querySelectorAll('.k-link-Image-placeholder')).toHaveLength(1);
    expect(withoutPlaceholder.querySelectorAll('.k-link-Image-placeholder')).toHaveLength(0);
  });
  ...
  it('renders a placeholder after having src updated to null', () => {
    ...
    expect(container.querySelectorAll('.k-link-Image-placeholder')).toHaveLength(0);
    rerender(<Image src={null} withPlaceholder />);
    expect(container.querySelectorAll('.k-link-Image-placeholder')).toHaveLength(1);
  });
