...
describe('@k-link/core/Timeline', () => {
  ...
  it('handles active item correctly', () => {
    ...
    expect(secondActive.querySelectorAll('.k-link-Timeline-item[data-active]')).toHaveLength(2);
    expect(secondActive.querySelectorAll('.k-link-Timeline-item[data-line-active]')).toHaveLength(
      1
    );

    expect(thirdActive.querySelectorAll('.k-link-Timeline-item[data-active]')).toHaveLength(3);
    expect(thirdActive.querySelectorAll('.k-link-Timeline-item[data-line-active]')).toHaveLength(2);
  });
