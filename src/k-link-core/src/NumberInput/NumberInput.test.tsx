...
const getRightSection = (container: HTMLElement) =>
  container.querySelector('.k-link-NumberInput-rightSection');

const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.k-link-NumberInput-controlUp'));

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.k-link-NumberInput-controlDown'));
...
describe('@k-link/core/NumberInput', () => {
  checkAccessibility([
  ...
  itSupportsSystemProps({
    ...
    props: defaultProps,
    displayName: '@k-link/core/NumberInput',
