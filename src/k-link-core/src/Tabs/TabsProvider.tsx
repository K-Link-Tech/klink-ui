...
import { getSafeId } from '@k-link/utils';
import { useUncontrolled, useId } from '@k-link/hooks';
import { ClassNames, MantineColor, MantineNumberSize, Styles } from '@k-link/styles';
...
TabsProvider.displayName = '@k-link/core/TabsProvider';
