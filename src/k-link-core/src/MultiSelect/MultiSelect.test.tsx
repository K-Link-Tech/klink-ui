...
describe('@k-link/core/MultiSelect', () => {
  ...
  itSupportsSystemProps({
    ...
    props: defaultProps,
    displayName: '@k-link/core/MultiSelect',
  ...
  it('Has un-filtered list when disableSelectedItemFiltering is enabled', () => {
    ...
    expect(container.querySelectorAll('.k-link-MultiSelect-item')).toHaveLength(4);
  });
  ...
  it('Has un-filtered list when disableSelectedItemFiltering is disabled', () => {
    ...
    expect(container.querySelectorAll('.k-link-MultiSelect-item')).toHaveLength(2);
  });
});
