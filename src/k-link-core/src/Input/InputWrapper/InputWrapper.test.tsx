...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.k-link-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.k-link-InputWrapper-error'),
  getRequired: (container: HTMLElement) => container.querySelector('.k-link-InputWrapper-required'),
  getDescription: (container: HTMLElement) =>
    container.querySelector('.k-link-InputWrapper-description'),
};

describe('@k-link/core/InputWrapper', () => {
  itRendersChildren(InputWrapper, defaultProps);
  itSupportsSystemProps({
    component: InputWrapper,
    props: defaultProps,
    displayName: '@k-link/core/InputWrapper',
