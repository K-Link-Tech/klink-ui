...
import { DefaultProps, Selectors, useComponentDefaultProps } from '@k-link/styles';
import { createScopedKeydownHandler } from '@k-link/utils';
...
AccordionControl.displayName = '@k-link/core/AccordionControl';
