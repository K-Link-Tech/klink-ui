...
source: 'k-link-form/src'
---

import { FormDemos } from '@k-link/demos';

## Usage

`@k-link/form` package exports several functions that can be used in [validation rules object](/form/validation/#validation-with-rules-object).
...
```tsx
import { useForm, isNotEmpty } from '@k-link/form';
...
```tsx
import { useForm, isEmail } from '@k-link/form';
...
```tsx
import { useForm, matches } from '@k-link/form';
...
```tsx
import { useForm, isInRange } from '@k-link/form';
...
```tsx
import { useForm, hasLength } from '@k-link/form';
...
```tsx
import { useForm, matchesField } from '@k-link/form';
