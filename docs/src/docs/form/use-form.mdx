...
import: "import { useForm } from '@klink-ui/form';"
...
`@klink-ui/form` package does not depend on any other libraries, you can use it with or without `@klink-ui/core` inputs:
...
import { useForm, UseFormReturnType } from '@klink-ui/form';
