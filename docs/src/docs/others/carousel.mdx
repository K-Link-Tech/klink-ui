...
import: "import { Carousel } from '@klink-ui/carousel';"
source: 'klink-ui-carousel/src'
docs: 'others/carousel.mdx'
installation: '@klink-ui/carousel'
styles: ['Carousel']
license: MIT
---

import { CarouselDemos } from '@klink-ui/demos';
...
```bash
yarn add embla-carousel-react @klink-ui/carousel
```

Install with npm:

```bash
npm install embla-carousel-react @klink-ui/carousel
```

## Usage

`@klink-ui/carousel` package is based on [embla carousel](https://www.embla-carousel.com/),
...
Note that plugins are not installed with `@klink-ui/carousel` package and you will need to
...
To solve this issue use `useAnimationOffsetEffect` hook exported from `@klink-ui/carousel` package.
