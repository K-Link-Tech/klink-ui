...
import: "import { ModalsProvider } from '@klink-ui/modals';"
source: 'klink-ui-modals/src'
docs: 'others/modals.mdx'
installation: '@klink-ui/modals'
license: MIT
---

import { ModalsDemos } from '@klink-ui/demos';
...
```bash
yarn add @klink-ui/modals
```

Install with npm:

```bash
npm install @klink-ui/modals
```
...
import { ModalsProvider } from '@klink-ui/modals';
...
@klink-ui/modals package includes special modal that can be used for confirmations.
...
```tsx
import { ContextModalProps, ModalsProvider } from '@klink-ui/modals';
import { Text, Button } from '@klink-ui/core';
...
declare module '@klink-ui/modals' {
...
```tsx
import { openContextModal, closeContextModal } from '@klink-ui/modals';
openContextModal({
  modal: 'demonstration',
