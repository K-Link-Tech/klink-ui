...
import: "import { useShallowEffect } from '@klink-ui/hooks';"
docs: 'hooks/use-shallow-effect.mdx'
source: 'klink-ui-hooks/src/use-shallow-effect/use-shallow-effect.ts'
---
...
import { useShallowEffect } from '@klink-ui/hooks';
