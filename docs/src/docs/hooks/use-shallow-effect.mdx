...
import: "import { useShallowEffect } from '@k-link/hooks';"
docs: 'hooks/use-shallow-effect.mdx'
source: 'k-link-hooks/src/use-shallow-effect/use-shallow-effect.ts'
---
...
import { useShallowEffect } from '@k-link/hooks';
