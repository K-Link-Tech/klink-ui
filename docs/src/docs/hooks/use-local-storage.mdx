...
import: "import { useLocalStorage } from '@k-link/hooks';"
docs: 'hooks/use-local-storage.mdx'
source: 'k-link-hooks/src/use-local-storage/use-local-storage.ts'
---
...
```tsx
import { useLocalStorage } from '@k-link/hooks';
...
```tsx
import { useLocalStorage } from '@k-link/hooks';
import { ActionIcon, ColorScheme } from '@k-link/core';
...
```tsx
import { useSessionStorage } from '@k-link/hooks';
