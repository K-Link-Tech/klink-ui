...
import: "import { useMergedRef } from '@k-link/hooks';"
docs: 'hooks/use-merged-ref.mdx'
source: 'k-link-hooks/src/use-merged-ref/use-merged-ref.ts'
---
...
```tsx
import { useRef } from 'react';
import { useClickOutside, mergeRefs } from '@k-link/hooks';
