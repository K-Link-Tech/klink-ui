...
import: "import { useMergedRef } from '@klink-ui/hooks';"
docs: 'hooks/use-merged-ref.mdx'
source: 'klink-ui-hooks/src/use-merged-ref/use-merged-ref.ts'
---
...
```tsx
import { useRef } from 'react';
import { useClickOutside, mergeRefs } from '@klink-ui/hooks';
