...
import: "import { useInputState } from '@k-link/hooks';"
docs: 'hooks/use-input-state.mdx'
source: 'k-link-hooks/src/use-input-state/use-input-state.ts'
---
...
import { useInputState } from '@k-link/hooks';
import { TextInput, NumberInput } from '@k-link/core';
