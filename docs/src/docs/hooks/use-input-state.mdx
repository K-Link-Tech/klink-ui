...
import: "import { useInputState } from '@klink-ui/hooks';"
docs: 'hooks/use-input-state.mdx'
source: 'klink-ui-hooks/src/use-input-state/use-input-state.ts'
---
...
Hook works with all Klink UI and native inputs:

```tsx
import { useState } from 'react';
import { useInputState } from '@klink-ui/hooks';
import { TextInput, NumberInput } from '@klink-ui/core';
