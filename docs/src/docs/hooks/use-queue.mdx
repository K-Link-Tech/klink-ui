...
import: "import { useQueue } from '@klink-ui/hooks';"
docs: 'hooks/use-queue.mdx'
source: 'klink-ui-hooks/src/use-queue/use-queue.ts'
---

import { NotificationsDemos } from '@klink-ui/demos';

## Usage

use-queue limits the amount of data in current state and places the rest of it in a queue.
For example, in [@klink-ui/notifications](/others/notifications/) package amount of
...
```tsx
import { useQueue } from '@klink-ui/hooks';
...
Example of use-queue hook usage in [Klink UI notifications system](/others/notifications/). By default
