...
import: "import { useQueue } from '@k-link/hooks';"
docs: 'hooks/use-queue.mdx'
source: 'k-link-hooks/src/use-queue/use-queue.ts'
---

import { NotificationsDemos } from '@k-link/demos';

## Usage

use-queue limits the amount of data in current state and places the rest of it in a queue.
For example, in [@k-link/notifications](/others/notifications/) package amount of
...
```tsx
import { useQueue } from '@k-link/hooks';
