...
import: "import { useFocusTrap } from '@k-link/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'k-link-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@k-link/demos';
...
```tsx
import { useFocusTrap } from '@k-link/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@k-link/hooks';
