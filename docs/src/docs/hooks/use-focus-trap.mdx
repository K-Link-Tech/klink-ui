...
import: "import { useFocusTrap } from '@klink-ui/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'klink-ui-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@klink-ui/demos';
...
```tsx
import { useFocusTrap } from '@klink-ui/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@klink-ui/hooks';
...
use-focus-trap is used in some Klink UI components: [Modal](/core/modal/), [Drawer](/core/drawer/), [Menu](/core/menu/) and others.
