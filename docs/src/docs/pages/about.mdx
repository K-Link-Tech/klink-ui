...
Mantine development was started in January 2021 and 1.0 version was published on [May 3rd, 2021](https://github.com/mantinedev/klink-ui/releases/tag/1.0.0),
...
Mantine is built and maintained by [Vitaly Rtishchev](https://github.com/rtivital) and [more than 150 other contributors](https://github.com/mantinedev/klink-ui/graphs/contributors).
