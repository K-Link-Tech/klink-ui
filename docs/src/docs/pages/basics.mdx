...
import { SliderDemos, CreateStylesDemos } from '@klink-ui/demos';

# Learn the basics

This guide will help you get familiar with core Klink UI concepts.
Please read this guide, [theming](/theming/klink-ui-provider/) and [styles](/styles/sx/) sections before starting development
...
To configure theme, wrap your app with a [MantineProvider](/theming/klink-ui-provider/) component:
...
import { Button, Paper, TextInput } from '@klink-ui/core';
...
`@klink-ui/core` package export types to help you build components and styles with TypeScript:
...
```tsx
import type { ButtonProps } from '@klink-ui/core';
```
