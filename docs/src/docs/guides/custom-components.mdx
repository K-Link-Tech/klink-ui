...
This guide will help you learn how to integrate custom components with [MantineProvider](/theming/klink-ui-provider/)
...
import { createStyles, MantineNumberSize } from '@klink-ui/core';
...
```tsx
// MyComponent.tsx
import { DefaultProps, Selectors, MantineNumberSize, Box } from '@klink-ui/core';
...
You can also add `styles` and `classNames` on [MantineProvider](/theming/klink-ui-provider/):
...
Then you will be able to add [default props](/theming/default-props/) on [MantineProvider](/theming/klink-ui-provider/):
...
```tsx
import { DefaultProps } from '@klink-ui/core';
