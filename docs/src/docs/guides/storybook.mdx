...
```tsx
// theme.ts file
import type { MantineThemeOverride } from '@klink-ui/core';
...
To add [MantineProvider](/theming/klink-ui-provider/) (and other providers) to your Storybook setup create `preview.tsx`
...
import { MantineProvider, ColorSchemeProvider } from '@klink-ui/core';
import { theme } from './theme';
