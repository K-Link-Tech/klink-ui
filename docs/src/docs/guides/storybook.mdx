...
```tsx
// theme.ts file
import type { MantineThemeOverride } from '@k-link/core';
...
To add [MantineProvider](/theming/k-link-provider/) (and other providers) to your Storybook setup create `preview.tsx`
...
import { MantineProvider, ColorSchemeProvider } from '@k-link/core';
import { theme } from './theme';
