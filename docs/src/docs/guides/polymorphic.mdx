...
import { ButtonDemos } from '@klink-ui/demos';

# Polymorphic components

Some of the Klink UI components ([Button](/core/button/), [Text](/core/text/), etc.) accept special `component` prop that lets you
...
import { Box, createPolymorphicComponent } from '@klink-ui/core';
