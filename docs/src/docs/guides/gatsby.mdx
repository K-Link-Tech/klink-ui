...
The easiest way to get started is to use [the template on GitHub](https://github.com/mantinedev/klink-ui-gatsby-template):

1. Open [template page on GitHub](https://github.com/mantinedev/klink-ui-gatsby-template)
...
<PackagesInstallation extraPackages={['@klink-ui/ssr']} />
