...
The easiest way to get started is to use [the template on GitHub](https://github.com/mantinedev/k-link-gatsby-template):

1. Open [template page on GitHub](https://github.com/mantinedev/k-link-gatsby-template)
...
<PackagesInstallation extraPackages={['@k-link/ssr']} />
