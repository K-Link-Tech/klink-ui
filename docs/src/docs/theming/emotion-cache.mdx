...
the same emotion cache both to [MantineProvider](/theming/k-link-provider/)
and to the server side code.

Example with Next.js ([view full code on GitHub](https://github.com/mantinedev/k-link-next-template/tree/v5-rtl)):

```tsx
// rtl-cache.ts
import rtlPlugin from 'stylis-plugin-rtl';
import { createEmotionCache } from '@k-link/core';
...
import { ServerStyles, createStylesServer } from '@k-link/next';
import { rtlCache } from '../rtl-cache';
