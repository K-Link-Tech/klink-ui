...
Default props defined on [MantineProvider](/theming/klink-ui-provider) will be overridden with
...
```tsx
import { MantineProvider, ButtonProps, SwitchProps } from '@klink-ui/core';
