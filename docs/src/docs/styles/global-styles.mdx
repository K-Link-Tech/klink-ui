...
Usually global styles depend on theme, you can render `Global` component anywhere within [MantineProvider](/theming/k-link-provider/):

```tsx
import { Global, MantineProvider } from '@k-link/core';
