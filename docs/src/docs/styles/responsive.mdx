...
import { MediaQueryDemos, CreateStylesDemos } from '@k-link/demos';

# Responsive styles

`@k-link/core` package exports several components that can help you organize responsive styles without writing CSS.
...
You can configure these values with [MantineProvider](/theming/k-link-provider/):
