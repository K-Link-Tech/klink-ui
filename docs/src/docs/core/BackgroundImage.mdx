...
import: "import { BackgroundImage } from '@klink-ui/core';"
source: 'klink-ui-core/src/BackgroundImage/BackgroundImage.tsx'
docs: 'core/BackgroundImage.mdx'
---

import { BackgroundImageDemos } from '@klink-ui/demos';
...
```tsx
import { BackgroundImage } from '@klink-ui/core';
...
function Demo() {
  return (
    <BackgroundImage
      ...
      target="_blank"
      src="https://klink-ui.dev/image.png"
    />
  );
}
```
