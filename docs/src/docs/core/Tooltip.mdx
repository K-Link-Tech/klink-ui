...
import: "import { Tooltip } from '@klink-ui/core';"
source: 'klink-ui-core/src/Tooltip/Tooltip.tsx'
docs: 'core/Tooltip.mdx'
styles: ['Tooltip']
---

import { TooltipDemos } from '@klink-ui/demos';
...
all Klink UI components support ref out of the box.

```tsx
import { Tooltip, Badge } from '@klink-ui/core';
...
import { Tooltip } from '@klink-ui/core';
