...
import: "import { Tooltip } from '@k-link/core';"
source: 'k-link-core/src/Tooltip/Tooltip.tsx'
docs: 'core/Tooltip.mdx'
styles: ['Tooltip']
---

import { TooltipDemos } from '@k-link/demos';
...
```tsx
import { Tooltip, Badge } from '@k-link/core';
...
import { Tooltip } from '@k-link/core';
