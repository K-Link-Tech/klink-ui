...
props: ['ScrollArea']
styles: ['ScrollArea']
import: "import { ScrollArea } from '@klink-ui/core';"
source: 'klink-ui-core/src/ScrollArea/ScrollArea.tsx'
docs: 'core/ScrollArea.mdx'
---

import { AppShellDemos, ScrollAreaDemos } from '@klink-ui/demos';
...
ScrollArea integrates seamlessly with all Klink UI components that can require scrollbars.
