...
props: ['ActionIcon']
import: "import { ActionIcon } from '@klink-ui/core';"
source: 'klink-ui-core/src/ActionIcon/ActionIcon.tsx'
docs: 'core/ActionIcon.mdx'
---

import { ActionIconDemos } from '@klink-ui/demos';
  ...
  return (
    <ActionIcon
      sx={{
        ...
        '&[data-loading]': { backgroundColor: 'error' },
      }}
    />
  );
}
...
function Demo() {
  return (
    <ActionIcon component="a" href="https://klink-ui.dev/core/">
      Anchor element
    </ActionIcon>
  );
}
