...
import: "import { Input } from '@klink-ui/core';"
source: 'klink-ui-core/src/Input/Input.tsx'
docs: 'core/Input.mdx'
styles: ['Input', 'Input.Wrapper']
---

import { InputDemos } from '@klink-ui/demos';
...
You can add [default props](/theming/default-props/) on [MantineProvider](/theming/klink-ui-provider/)
...
on [MantineProvider](/theming/klink-ui-provider/) to add styles to all Inputs:
