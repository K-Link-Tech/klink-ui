...
import: "import { Input } from '@k-link/core';"
source: 'k-link-core/src/Input/Input.tsx'
docs: 'core/Input.mdx'
styles: ['Input', 'Input.Wrapper']
---

import { InputDemos } from '@k-link/demos';
...
You can add [default props](/theming/default-props/) on [MantineProvider](/theming/k-link-provider/)
...
on [MantineProvider](/theming/k-link-provider/) to add styles to all Inputs:
