...
props: ['Drawer']
import: "import { Drawer } from '@klink-ui/core';"
source: 'klink-ui-core/src/Drawer/Drawer.tsx'
docs: 'core/Drawer.mdx'
styles: ['Drawer']
---

import { DrawerDemos } from '@klink-ui/demos';
...
You can use the following modular components to have full control over the `Drawer` rendering:
...
```tsx
import { Drawer } from '@klink-ui/core';
