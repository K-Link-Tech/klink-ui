...
props: ['Title']
import: "import { Title } from '@klink-ui/core';"
source: 'klink-ui-core/src/Title/Title.tsx'
docs: 'core/Title.mdx'
---

import { TitleDemos } from '@klink-ui/demos';

## Usage

Use Title component to render h1-h6 headings with Klink UI theme styles.
