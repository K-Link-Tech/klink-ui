...
import: "import { Accordion } from '@klink-ui/core';"
source: 'klink-ui-core/src/Accordion/Accordion.tsx'
docs: 'core/Accordion.mdx'
styles: ['Accordion']
---

import { AccordionDemos } from '@klink-ui/demos';
...
```tsx
import { Accordion, rem } from '@klink-ui/core';
...
`AccordionProps` type exported from `@klink-ui/core` is a generic, it accepts boolean type that
describes `multiple` state:

```tsx
import type { AccordionProps } from '@klink-ui/core';
