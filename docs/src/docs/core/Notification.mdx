...
props: ['Notification']
import: "import { Notification } from '@klink-ui/core';"
source: 'klink-ui-core/src/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@klink-ui/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@klink-ui/notifications](/others/notifications/) package.
...
```tsx
<Notification closeButtonProps={{ color: 'error' }} />
