...
props: ['Notification']
import: "import { Notification } from '@k-link/core';"
source: 'k-link-core/src/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@k-link/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@k-link/notifications](/others/notifications/) package.
