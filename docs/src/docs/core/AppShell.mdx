...
import: "import { AppShell, Navbar, Header, Aside, Footer } from '@k-link/core';"
source: 'k-link-core/src/AppShell/AppShell.tsx'
docs: 'core/AppShell.mdx'
styles: ['AppShell']
---

import { Anchor } from '@k-link/core';
import { AppShellDemos } from '@k-link/demos';

## Usage

AppShell is a layout component that can be used to create a common Header - Navbar - Footer - Aside - Content layout pattern.
AppShell, Header, Footer, Aside and Navbar components include bare minimum default styles to simplify customization. [View full source code](https://github.com/mantinedev/k-link/tree/master/src/k-link-demos/src/demos/core/AppShell)
...
Navbar and Aside components can be used outside of AppShell context ([View full source code](https://github.com/mantinedev/k-link/tree/master/src/k-link-demos/src/demos/core/AppShell)):
...
`Navbar.Section` and `Aside.Section` components can be used with [ScrollArea](/core/scroll-area/) component ([View full source code](https://github.com/mantinedev/k-link/tree/master/src/k-link-demos/src/demos/core/AppShell)):
