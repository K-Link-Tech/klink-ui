...
props: ['FocusTrap']
import: "import { FocusTrap } from '@klink-ui/core';"
source: 'klink-ui-core/src/FocusTrap/FocusTrap.tsx'
docs: 'core/FocusTrap.mdx'
---

import { FocusTrapDemos } from '@klink-ui/demos';

## Usage

FocusTrap is a component implementation of [use-focus-trap](/hooks/use-focus-trap/) hook,
it is used in all Klink UI components that require focus trap ([Modal](/core/modal/), [DatePicker](/dates/date-picker/), [Popover](/core/popover/), etc.).
