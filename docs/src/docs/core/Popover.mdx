...
import: "import { Popover } from '@klink-ui/core';"
source: 'klink-ui-core/src/Popover/Popover.tsx'
docs: 'core/Popover.mdx'
styles: ['Popover']
---

import { PopoverDemos, PasswordInputDemos } from '@klink-ui/demos';
...
import { Popover, Button } from '@klink-ui/core';
...
Custom components must provide a prop to get root element ref, all Klink UI components support ref out of the box.
...
function Demo() {
  return (
    <>
      ...
      {/* OK */}
      <Popover.Target>
        <Button>Klink UI component – ok</Button>
      </Popover.Target>
...
import { Popover } from '@klink-ui/core';
