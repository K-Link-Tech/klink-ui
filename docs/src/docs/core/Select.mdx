...
props: ['Select']
import: "import { Select } from '@klink-ui/core';"
source: 'klink-ui-core/src/Select/Select.tsx'
docs: 'core/Select.mdx'
styles: ['Select']
---

import { SelectDemos } from '@klink-ui/demos';
...
```tsx
<Select clearable clearButtonProps={{ 'aria-label': 'Clear select field' }} />
```
