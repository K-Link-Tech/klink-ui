...
props: ['PinInput']
import: "import { PinInput } from '@k-link/core';"
source: 'k-link-core/src/components/PinInput/PinInput.tsx'
docs: 'core/PinInput.mdx'
styles: ['PinInput']
---

import { PinInputDemos } from '@k-link/demos';
...
```tsx
import { PinInput } from '@k-link/core';
