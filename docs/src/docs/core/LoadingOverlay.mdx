...
import: "import { LoadingOverlay } from '@k-link/core';"
source: 'k-link-core/src/LoadingOverlay/LoadingOverlay.tsx'
docs: 'core/LoadingOverlay.mdx'
---

import { LoadingOverlayDemos } from '@k-link/demos';
...
```tsx
import { LoadingOverlay } from '@k-link/core';
...
You can configure default loader in [MantineProvider](/theming/k-link-provider/),
