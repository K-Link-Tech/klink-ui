...
import: "import { LoadingOverlay } from '@klink-ui/core';"
source: 'klink-ui-core/src/LoadingOverlay/LoadingOverlay.tsx'
docs: 'core/LoadingOverlay.mdx'
---

import { LoadingOverlayDemos } from '@klink-ui/demos';
...
```tsx
import { LoadingOverlay } from '@klink-ui/core';
...
You can configure default loader in [MantineProvider](/theming/klink-ui-provider/),
