...
props: ['MediaQuery']
import: "import { MediaQuery } from '@k-link/core';"
source: 'k-link-core/src/MediaQuery/MediaQuery.tsx'
docs: 'core/MediaQuery.mdx'
---

import { DEFAULT_THEME } from '@k-link/core';
import { MediaQueryDemos } from '@k-link/demos';
...
import { MediaQuery } from '@k-link/core';
