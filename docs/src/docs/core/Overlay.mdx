...
props: ['Overlay']
import: "import { Overlay } from '@k-link/core';"
source: 'k-link-core/src/Overlay/Overlay.tsx'
docs: 'core/Overlay.mdx'
---

import { OverlayDemos, CardDemos } from '@k-link/demos';
...
```tsx
import { Overlay } from '@k-link/core';
