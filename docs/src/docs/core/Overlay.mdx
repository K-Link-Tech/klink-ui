...
props: ['Overlay']
import: "import { Overlay } from '@klink-ui/core';"
source: 'klink-ui-core/src/Overlay/Overlay.tsx'
docs: 'core/Overlay.mdx'
---

import { OverlayDemos, CardDemos } from '@klink-ui/demos';
...
```tsx
import { Overlay } from '@klink-ui/core';
