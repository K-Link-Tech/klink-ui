...
props: ['Grid', 'Col']
import: "import { Grid } from '@k-link/core';"
source: 'k-link-core/src/Grid/Grid.tsx'
docs: 'core/Grid.mdx'
---

import { GridDemos } from '@k-link/demos';
...
You can configure breakpoint values with [MantineProvider](/theming/k-link-provider/).
...
```tsx
import { Grid, Container } from '@k-link/core';
