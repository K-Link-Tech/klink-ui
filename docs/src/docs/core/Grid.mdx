...
props: ['Grid', 'Col']
import: "import { Grid } from '@klink-ui/core';"
source: 'klink-ui-core/src/Grid/Grid.tsx'
docs: 'core/Grid.mdx'
---

import { GridDemos } from '@klink-ui/demos';
...
You can configure breakpoint values with [MantineProvider](/theming/klink-ui-provider/).
...
```tsx
import { Grid, Container } from '@klink-ui/core';
