...
import: "import { SegmentedControl } from '@klink-ui/core';"
source: 'klink-ui-core/src/SegmentedControl/SegmentedControl.tsx'
docs: 'core/SegmentedControl.mdx'
styles: ['SegmentedControl']
---

import { SegmentedControlDemos } from '@klink-ui/demos';
