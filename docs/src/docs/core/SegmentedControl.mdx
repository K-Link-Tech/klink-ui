...
import: "import { SegmentedControl } from '@k-link/core';"
source: 'k-link-core/src/SegmentedControl/SegmentedControl.tsx'
docs: 'core/SegmentedControl.mdx'
styles: ['SegmentedControl']
---

import { SegmentedControlDemos } from '@k-link/demos';
