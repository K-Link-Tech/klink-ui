...
import: "import { HoverCard } from '@klink-ui/core';"
source: 'klink-ui-core/src/HoverCard/HoverCard.tsx'
docs: 'core/HoverCard.mdx'
styles: ['HoverCard']
---

import { HoverCardDemos } from '@klink-ui/demos';
...
```tsx
import { HoverCard, Badge } from '@klink-ui/core';
...
function Demo() {
  return (
    <>
      ...
      {/* OK */}
      <HoverCard.Target>
        <Badge>Klink UI component – ok</Badge>
      </HoverCard.Target>
...
import { HoverCard } from '@klink-ui/core';
