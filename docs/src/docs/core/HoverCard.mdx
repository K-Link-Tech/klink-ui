...
import: "import { HoverCard } from '@k-link/core';"
source: 'k-link-core/src/HoverCard/HoverCard.tsx'
docs: 'core/HoverCard.mdx'
styles: ['HoverCard']
---

import { HoverCardDemos } from '@k-link/demos';
...
```tsx
import { HoverCard, Badge } from '@k-link/core';
...
import { HoverCard } from '@k-link/core';
