...
props: ['Stepper', 'Step']
import: "import { Stepper } from '@klink-ui/core';"
source: 'klink-ui-core/src/Stepper/Stepper.tsx'
docs: 'core/Stepper.mdx'
styles: ['Stepper']
---

import { StepperDemos } from '@klink-ui/demos';
...
You can configure breakpoints with [MantineProvider](/theming/klink-ui-provider) or use number to set breakpoint:
...
Loader will replace step icon. You can configure default loader in [MantineProvider](/theming/klink-ui-provider/).
