...
props: ['Stepper', 'Step']
import: "import { Stepper } from '@k-link/core';"
source: 'k-link-core/src/Stepper/Stepper.tsx'
docs: 'core/Stepper.mdx'
styles: ['Stepper']
---

import { StepperDemos } from '@k-link/demos';
...
You can configure breakpoints with [MantineProvider](/theming/k-link-provider) or use number to set breakpoint:
...
Loader will replace step icon. You can configure default loader in [MantineProvider](/theming/k-link-provider/).
