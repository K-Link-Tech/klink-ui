...
import: "import { Pagination } from '@klink-ui/core';"
source: 'klink-ui-core/src/Pagination/Pagination.tsx'
docs: 'core/Pagination.mdx'
styles: ['Pagination']
---

import { PaginationDemos } from '@klink-ui/demos';
...
If you need more flexibility @klink-ui/hooks exports [use-pagination](/hooks/use-pagination/) hook,
