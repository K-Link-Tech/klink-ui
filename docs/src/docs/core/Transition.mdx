...
props: ['Transition']
import: "import { Transition } from '@klink-ui/core';"
source: 'klink-ui-core/src/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from '@klink-ui/demos';
...
Klink UI includes several premade transitions:
...
```tsx
import { Transition } from '@klink-ui/core';
