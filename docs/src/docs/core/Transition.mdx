...
props: ['Transition']
import: "import { Transition } from '@k-link/core';"
source: 'k-link-core/src/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from '@k-link/demos';
...
```tsx
import { Transition } from '@k-link/core';
