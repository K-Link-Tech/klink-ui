...
import: "import { Space } from '@klink-ui/core';"
source: 'klink-ui-core/src/Space/Space.tsx'
docs: 'core/Space.mdx'
---

import { SpaceDemos } from '@klink-ui/demos';
...
In most cases, you would want to use margin props instead of Space when working with Klink UI components:
