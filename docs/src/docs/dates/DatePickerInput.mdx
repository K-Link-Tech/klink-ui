...
import: "import { DatePickerInput } from '@klink-ui/dates';"
source: 'klink-ui-dates/src/components/DatePickerInput/DatePickerInput.tsx'
docs: 'dates/DatePickerInput.mdx'
styles: ['DatePickerInput']
---

import { DatePickerInputDemos } from '@klink-ui/demos';

## DatePicker props

`DatePickerInput` supports all props from [DatePicker](https://klink-ui.dev/dates/date-picker/),
