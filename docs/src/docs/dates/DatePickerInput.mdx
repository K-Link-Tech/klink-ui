...
import: "import { DatePickerInput } from '@k-link/dates';"
source: 'k-link-dates/src/components/DatePickerInput/DatePickerInput.tsx'
docs: 'dates/DatePickerInput.mdx'
styles: ['DatePickerInput']
---

import { DatePickerInputDemos } from '@k-link/demos';

## DatePicker props

`DatePickerInput` supports all props from [DatePicker](https://k-link.dev/dates/date-picker/),
