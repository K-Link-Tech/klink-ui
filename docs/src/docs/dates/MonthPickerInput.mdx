...
import: "import { MonthPickerInput } from '@k-link/dates';"
source: 'k-link-dates/src/components/MonthPickerInput/MonthPickerInput.tsx'
docs: 'dates/MonthPickerInput.mdx'
styles: ['MonthPickerInput']
---

import { MonthPickerInputDemos } from '@k-link/demos';

## MonthPicker props

`MonthPickerInput` supports all props from [MonthPicker](https://k-link.dev/dates/month-picker/),
