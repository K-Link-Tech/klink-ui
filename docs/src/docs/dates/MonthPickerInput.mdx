...
import: "import { MonthPickerInput } from '@klink-ui/dates';"
source: 'klink-ui-dates/src/components/MonthPickerInput/MonthPickerInput.tsx'
docs: 'dates/MonthPickerInput.mdx'
styles: ['MonthPickerInput']
---

import { MonthPickerInputDemos } from '@klink-ui/demos';

## MonthPicker props

`MonthPickerInput` supports all props from [MonthPicker](https://klink-ui.dev/dates/month-picker/),
