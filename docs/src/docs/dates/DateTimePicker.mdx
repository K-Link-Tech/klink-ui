...
import: "import { DateTimePicker } from '@k-link/dates';"
source: 'k-link-dates/src/components/DateTimePicker/DateTimePicker.tsx'
docs: 'dates/DateTimePicker.mdx'
styles: ['DateTimePicker']
---

import { DateTimePickerDemos } from '@k-link/demos';

## DatePicker props

`DateTimePicker` supports all props from [DatePicker](https://k-link.dev/dates/date-picker/),
