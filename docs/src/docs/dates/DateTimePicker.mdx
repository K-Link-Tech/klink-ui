...
import: "import { DateTimePicker } from '@klink-ui/dates';"
source: 'klink-ui-dates/src/components/DateTimePicker/DateTimePicker.tsx'
docs: 'dates/DateTimePicker.mdx'
styles: ['DateTimePicker']
---

import { DateTimePickerDemos } from '@klink-ui/demos';

## DatePicker props

`DateTimePicker` supports all props from [DatePicker](https://klink-ui.dev/dates/date-picker/),
