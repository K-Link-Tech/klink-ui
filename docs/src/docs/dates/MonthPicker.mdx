...
props: ['MonthPicker']
import: "import { MonthPicker } from '@k-link/dates';"
source: 'k-link-dates/src/components/MonthPicker/MonthPicker.tsx'
docs: 'dates/MonthPicker.mdx'
styles: ['MonthPicker']
---

import { MonthPickerDemos } from '@k-link/demos';
...
Usually it is better to specify `@k-link/dates` package locale in [DatesProvider](/dates/date-provider/),
