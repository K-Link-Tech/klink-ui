...
props: ['MonthPicker']
import: "import { MonthPicker } from '@klink-ui/dates';"
source: 'klink-ui-dates/src/components/MonthPicker/MonthPicker.tsx'
docs: 'dates/MonthPicker.mdx'
styles: ['MonthPicker']
---

import { MonthPickerDemos } from '@klink-ui/demos';
...
Usually it is better to specify `@klink-ui/dates` package locale in [DatesProvider](/dates/date-provider/),
