...
import: "import { YearPickerInput } from '@klink-ui/dates';"
source: 'klink-ui-dates/src/components/YearPickerInput/YearPickerInput.tsx'
docs: 'dates/YearPickerInput.mdx'
styles: ['YearPickerInput']
---

import { YearPickerInputDemos } from '@klink-ui/demos';

## YearPicker props

`YearPickerInput` supports all props from [YearPicker](https://klink-ui.dev/dates/year-picker/),
