...
import { Container } from '@k-link/core';
    ...
    <>
      <Container size={1100}>
        <P>
          ...
          <A href="https://github.com/mantinedev/k-link/issues/new">create an issue</A>. Otherwise,
          here are some learning materials that will help you get started with Klink UI:
        </P>
        <Ul>
          <Li>
          ...
          <Li>
            <GatsbyLink to="/theming/k-link-provider/">
